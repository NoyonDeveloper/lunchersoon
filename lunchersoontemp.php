...
$button_under_content = get_post_meta(get_the_ID(),"button under content",true);
$button_label = get_post_meta(get_the_ID(),"button label", true);
 ...
 ?>
	...
	<aside id="fh5co-aside" role="sidebar" class="text-center header-image">
		<h1 id="fh5co-logo">
							...
							<div class="col-lg-7 animate-box">
								<form action="#" id="fh5co-subscribe">
									<div class="form-group">
										...
										<p class="tip"><?php echo esc_attr($button_under_content); ?></p>
									</div>
								</form>
							</div>
						</div>
